    ...
    <div className={isMobile && !menuOpened ? 'no-sidebar' : 'sidebar'}>
      <nav className="navbar">
        <div className="logo-container">
          <span className={isMobile && !menuOpened ? 'hidden' : 'logo'}>RE/ROOM</span>
          { isMobile && (
            <>
              <button
                type="button"
        ...
        <ul className={isMobile && !menuOpened ? 'hidden' : 'navbar-ul'}>
          <li>
            <NavLink to="/" className={({ isActive }) => (isActive ? 'active-link' : 'nav-link')} onClick={closeMenu}>
              Rooms
            </NavLink>
          </li>
          <li>
            <NavLink to="/add-reservation" className={({ isActive }) => (isActive ? 'active-link' : 'nav-link')} onClick={closeMenu}>
              Make a reservation
            </NavLink>
          </li>
          <li>
            <NavLink to="/my-reservations" className={({ isActive }) => (isActive ? 'active-link' : 'nav-link')} onClick={closeMenu}>
              My reservations
            </NavLink>
          </li>
          <li>
            <NavLink to="/my-rooms" className={({ isActive }) => (isActive ? 'active-link' : 'nav-link')} onClick={closeMenu}>
              My rooms
            </NavLink>
          </li>
          <li>
            <NavLink to="/add-room" className={({ isActive }) => (isActive ? 'active-link' : 'nav-link')} onClick={closeMenu}>
              Post a room
            </NavLink>
          </li>
        </ul>
